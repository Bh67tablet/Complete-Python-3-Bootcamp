...
sudo su - -c 'su - ec2-user -c "/home/ec2-user/anaconda3/bin/conda install jupyter -yq"'
sudo su - -c 'su - ec2-user -c "/home/ec2-user/anaconda3/bin/jupyter notebook --generate-config"'
sudo su - -c 'su - ec2-user -c "/home/ec2-user/anaconda3/bin/nohup jupyter notebook --no-browser --port=8888 --ip=0.0.0.0 &"'
